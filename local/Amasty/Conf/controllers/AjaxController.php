...
class Amasty_Conf_AjaxController extends Mage_Core_Controller_Front_Action
{
    ...
    /* fixcode for out-of-stock */
    public function statusAction(){
        $id  = $this->getRequest()->getParam('id');
        $html = '';
        $html .= '<a title="Email when in stock" href="'. Mage::helper('amconf')->getSaveUrl('stock',$id) .'" class="alert-stock link-stock-alert product-action">';
        $html .= '<span class="ic ic-alarm"></span>';
        $html .= '<span class="label">Email when in stock</span>';
        $html .= '</a>';
        echo $html;
    }
}