...
//                        Mage::helper('messagesalerule')->setMessageSalerule($product);
                        Mage::helper('messagesalerule')->setMessageSaleruleData();
                    }
                }
                else{
   ...
   //reload top cart
    ...
    private function addToCartResponse($product, $cart, $IsProductView, $params, $text){
       $result = array(
                  ...
                  //'b1_action' =>  'document.location = "'.Mage::getUrl('firecheckout').'";',
                  'b2_action' =>  'jQuery.confirm.hide();',
		          'is_add_to_cart' =>  '1'
        );
