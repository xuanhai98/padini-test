...
class Amasty_Shopby_Block_Adminhtml_Value_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function prepareFieldsetMain()
    {
        ...
        $fldMain->addType('gridinput','Amasty_Shopby_Lib_Varien_Data_Form_Element_Grid');
        ...
        if ($this->getRequest()->getParam('id')) {
            ...
            $fldMain->addField(
                ...
                'gridinput',
                array(
                    'label'     => $this->__('Categories Images'),
                    'name'      => 'additional_images',
                    'custom_block' => $categoriesBlock,
                    'before_element_html' => $this->getLayout()->createBlock('amshopby/adminhtml_value_edit_additional_categories_listimages')->toHtml(),
                    'after_element_html' => $this->getLayout()->createBlock('amshopby/adminhtml_value_edit_additional_categories_js')->toHtml()
                )
            );
        }
    }
